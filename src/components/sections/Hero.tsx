      ...
      <div className="hero-inner hero-inner-up">
        <div className="hero-content hero-content-up">
          ...
          <div className="video-box video-box-up">
            ...
            <script src="https://fast.wistia.com/embed/r0azs3dylh.js" async type="module"></script>
            <style>{`wistia-player[media-id='r0azs3dylh']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/r0azs3dylh/swatch'); display: block; filter: blur(5px); padding-top:56.25%; }`}</style>
            <wistia-player media-id="r0azs3dylh" aspect="1.7777777777777777"></wistia-player>
          </div>
